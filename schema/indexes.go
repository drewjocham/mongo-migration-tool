...
// IndexSpec describes an expected MongoDB index for a collection.
type IndexSpec struct {
	...
	AdditionalStatement string // free-form notes (e.g., collation)
}
...
// Register adds the index spec to the global registry.
...
// Indexes returns all registered index specs sorted by collection/name.
